...
class _SignupPageState extends State<SignupPage> {
          ...
          child: Column(
            ...
            children: <Widget>[
              ...
              if (_errorMessage.isNotEmpty)
                FadeInUp(duration: Duration(milliseconds: 1500), child: Text(
                  _errorMessage,
  ...
  Future<void> _signUp() async {
    ...
    if (connectivityResult == ConnectivityResult.none) {
      setState(() {
        _errorMessage = 'No internet connection. Please connect to Wi-Fi or mobile data.';
      });
      return;
    }
    ...
    if (user != null) {
      // Navigate to the dashboard screen upon successful sign-up
      //Navigator.pushReplacement(context, MaterialPageRoute(builder: (context) => DashboardScreen()));
      _errorMessage = 'Sign up Completed';
    } else {
      setState(() {
